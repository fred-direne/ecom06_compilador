...
class Parser():
    ...
    def parse(self):
        ...
        # @self.pg.production('comando : print PONTOEVIRGULA')
        # def comando(p):
        #     return p[0]
        ...
        @self.pg.production('oparitmetico : expression SOMA expression')
        ...
        def expression(p):
            if p[0].gettokentype() == 'NUMERO':
                return ast.Numero(p[0].value)
